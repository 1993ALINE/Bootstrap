...
<script>
  ...
  function myFunction() {
      ...
      window.location ="/addbranch?bankcode="+selectedValue;
  }
</script>
<style>
  .navbar-inverse{
          ...
          <div class="panel-body">
            <form:form method="post" modelAttribute="bankAccount" name="bankAccount" action="/addbank">
              ...
              <div class="form-group">
                ...
                <form:select path="bankName" id="select" class="form-control" onchange="myFunction()">
              ...
              <div class="form-group">
                ...
                <input id="accountNo" name="accountNo" class="form-control" maxlength="4" placeholder="Please Enter valid account no" type="text" maxlength="15" onkeyup="validateaccountNo(this)" value="${bankAccount.accountNo}" data-validation="required">
              </div>
              <div class="form-group">
              ...
              <div class="text-center">
                <a href="" class="btn btn-default btn-rounded" data-toggle="modal" data-target="#modal" style="background-color: #122b40;color: white">Submit</a>
              </div>
            </form:form>
              <form:form method="post" modelAttribute="bankAccount" name="bankAccount" action="/otp">
              <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                   aria-hidden="true">
                <div class="modal-dialog cascading-modal modal-avatar modal-sm" role="document">
                  <div class="modal-content">
                    <div class="modal-header text-center">
                      <img class="img-circle" src="https://1.bp.blogspot.com/-YQDiNtRT0dk/WMABgIQ1HSI/AAAAAAAAAUY/ckKbuO8nHF4rcCHD5YIlOxSbAWEUkfuEwCLcB/s1600/opt-authentication.png" style="margin-top: 40px;" alt="Image result for otp" width="150" height="100">
                    </div>
                    <div class="modal-body text-center mb-1">
                      <h5 class="mt-1 mb-2" style="color: red">OTP has been sent to your mobile</h5>
                      ...
                      <div class="text-center mt-4">
                        <button class="btn btn-cyan mt-1" style="alignment: left;background-color: #122b40;color: white;margin-right: 10%">Submit<i class=" "></i></button>
                        <button class="btn btn-cyan mt-1" style="alignment: right;background-color: #122b40;color: white">Close<i class=" "></i></button>
                      </div>
                    </div>
                  </div>
                </div>
